...
def fm1(): # 1[high] -> 01
    ...
    time.sleep(bitLen) # allows change in frequency to plateu
...
def sendStringF():
    ...
    print(bitArr) # ASCII encoded bit array
...
def hold400():
    ...
    pi.set_PWM_frequency(ESC, baseF)
...
def hold500():
    ...
    pi.set_PWM_frequency(ESC, highF)
